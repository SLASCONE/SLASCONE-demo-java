...
| [**lookupCustomerWithHttpInfo**](LookUpApi.md#lookupCustomerWithHttpInfo) | **POST** /api/v2/isv/{isv_id}/lookup/customer | Customer lookup (name -&gt; id) |
...
| [**lookupLicensesWithHttpInfo**](LookUpApi.md#lookupLicensesWithHttpInfo) | **POST** /api/v2/isv/{isv_id}/lookup/licenses | Returns all available licenses for a specific customer |
| [**lookupProduct**](LookUpApi.md#lookupProduct) | **POST** /api/v2/isv/{isv_id}/lookup/product | Product lookup (name -&gt; id) |
| [**lookupProductWithHttpInfo**](LookUpApi.md#lookupProductWithHttpInfo) | **POST** /api/v2/isv/{isv_id}/lookup/product | Product lookup (name -&gt; id) |
...
## lookupCustomerWithHttpInfo

> ApiResponse<UUID> lookupCustomer lookupCustomerWithHttpInfo(isvId, lookupCustomerDto)
...
public class Example {
    public static void main(String[] args) {
        ...
        LookupCustomerDto lookupCustomerDto = new LookupCustomerDto(); // LookupCustomerDto | 
        try {
            ApiResponse<UUID> response = apiInstance.lookupCustomerWithHttpInfo(isvId, lookupCustomerDto);
...
## lookupLicensesWithHttpInfo

> ApiResponse<List<UUID>> lookupLicenses lookupLicensesWithHttpInfo(isvId, lookupDto)
...
public class Example {
    public static void main(String[] args) {
        ...
        LookupDto lookupDto = new LookupDto(); // LookupDto | 
        try {
            ApiResponse<List<UUID>> response = apiInstance.lookupLicensesWithHttpInfo(isvId, lookupDto);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## lookupProductWithHttpInfo

> ApiResponse<UUID> lookupProduct lookupProductWithHttpInfo(isvId, lookupProductDto)
...
public class Example {
    public static void main(String[] args) {
        ...
        LookupProductDto lookupProductDto = new LookupProductDto(); // LookupProductDto | 
        try {
            ApiResponse<UUID> response = apiInstance.lookupProductWithHttpInfo(isvId, lookupProductDto);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
