 ...
 */
@JsonPropertyOrder({
  LicensesByKeyErrors.JSON_PROPERTY_ID,
  LicensesByKeyErrors.JSON_PROPERTY_MESSAGE,
  LicensesByKeyErrors.JSON_PROPERTY_HELP,
  LicensesByKeyErrors.JSON_PROPERTY_EXPECTED_ERRORS
})
...
public class LicensesByKeyErrors {
  ...
  public LicensesByKeyErrors id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public LicensesByKeyErrors message(@jakarta.annotation.Nullable String message) {
  ...
  public LicensesByKeyErrors help(@jakarta.annotation.Nullable String help) {
  ...
  public LicensesByKeyErrors expectedErrors(@jakarta.annotation.Nullable List<ErrorResultObjects> expectedErrors) {
   ...
   */
  @JsonAnySetter
  public LicensesByKeyErrors putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this LicensesByKeyErrors object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, licensesByKeyErrors.id) &&
        equalsNullable(this.message, licensesByKeyErrors.message) &&
        equalsNullable(this.help, licensesByKeyErrors.help) &&
        equalsNullable(this.expectedErrors, licensesByKeyErrors.expectedErrors)&&
        Objects.equals(this.additionalProperties, licensesByKeyErrors.additionalProperties);
  }
