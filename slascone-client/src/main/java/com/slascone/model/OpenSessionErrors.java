 ...
 */
@JsonPropertyOrder({
  OpenSessionErrors.JSON_PROPERTY_ID,
  OpenSessionErrors.JSON_PROPERTY_MESSAGE,
  OpenSessionErrors.JSON_PROPERTY_HELP,
  OpenSessionErrors.JSON_PROPERTY_EXPECTED_ERRORS
})
...
public class OpenSessionErrors {
  ...
  public OpenSessionErrors id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public OpenSessionErrors message(@jakarta.annotation.Nullable String message) {
  ...
  public OpenSessionErrors help(@jakarta.annotation.Nullable String help) {
  ...
  public OpenSessionErrors expectedErrors(@jakarta.annotation.Nullable List<ErrorResultObjects> expectedErrors) {
   ...
   */
  @JsonAnySetter
  public OpenSessionErrors putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this OpenSessionErrors object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, openSessionErrors.id) &&
        equalsNullable(this.message, openSessionErrors.message) &&
        equalsNullable(this.help, openSessionErrors.help) &&
        equalsNullable(this.expectedErrors, openSessionErrors.expectedErrors)&&
        Objects.equals(this.additionalProperties, openSessionErrors.additionalProperties);
  }
