 ...
 */
@JsonPropertyOrder({
  LicenseTypeDto.JSON_PROPERTY_ID,
  LicenseTypeDto.JSON_PROPERTY_NAME,
  LicenseTypeDto.JSON_PROPERTY_CREATED_DATE_UTC,
  LicenseTypeDto.JSON_PROPERTY_MODIFIED_DATE_UTC,
  LicenseTypeDto.JSON_PROPERTY_LAST_MODIFIED_BY
})
...
public class LicenseTypeDto {
  ...
  public LicenseTypeDto id(@jakarta.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public LicenseTypeDto name(@jakarta.annotation.Nullable String name) {
  ...
  public LicenseTypeDto createdDateUtc(@jakarta.annotation.Nullable OffsetDateTime createdDateUtc) {
  ...
  public LicenseTypeDto modifiedDateUtc(@jakarta.annotation.Nullable OffsetDateTime modifiedDateUtc) {
  ...
  public LicenseTypeDto lastModifiedBy(@jakarta.annotation.Nullable String lastModifiedBy) {
  ...
  /**
   * Return true if this LicenseTypeDto object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, licenseTypeDto.id) &&
        equalsNullable(this.name, licenseTypeDto.name) &&
        equalsNullable(this.createdDateUtc, licenseTypeDto.createdDateUtc) &&
        equalsNullable(this.modifiedDateUtc, licenseTypeDto.modifiedDateUtc) &&
        equalsNullable(this.lastModifiedBy, licenseTypeDto.lastModifiedBy);
  }
