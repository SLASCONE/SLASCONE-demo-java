 ...
 */
@JsonPropertyOrder({
  LimitationDto.JSON_PROPERTY_ID,
  LimitationDto.JSON_PROPERTY_PRODUCT_ID,
  LimitationDto.JSON_PROPERTY_NAME,
  LimitationDto.JSON_PROPERTY_DESCRIPTION,
  LimitationDto.JSON_PROPERTY_IS_AGGREGATABLE,
  LimitationDto.JSON_PROPERTY_CREATED_DATE_UTC,
  LimitationDto.JSON_PROPERTY_MODIFIED_DATE_UTC,
  LimitationDto.JSON_PROPERTY_LAST_MODIFIED_BY
})
...
public class LimitationDto {
  ...
  public static final String JSON_PROPERTY_IS_AGGREGATABLE = "is_aggregatable";
  @jakarta.annotation.Nullable
  ...
  public LimitationDto id(@jakarta.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public LimitationDto productId(@jakarta.annotation.Nonnull UUID productId) {
  ...
  public LimitationDto name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public LimitationDto description(@jakarta.annotation.Nullable String description) {
  ...
  public LimitationDto isAggregatable(@jakarta.annotation.Nullable Boolean isAggregatable) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IS_AGGREGATABLE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_AGGREGATABLE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsAggregatable(@jakarta.annotation.Nullable Boolean isAggregatable) {
    this.isAggregatable = isAggregatable;
  }


  public LimitationDto createdDateUtc(@jakarta.annotation.Nullable OffsetDateTime createdDateUtc) {
  ...
  public LimitationDto modifiedDateUtc(@jakarta.annotation.Nullable OffsetDateTime modifiedDateUtc) {
  ...
  public LimitationDto lastModifiedBy(@jakarta.annotation.Nullable String lastModifiedBy) {
  ...
  /**
   * Return true if this LimitationDto object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, limitationDto.id) &&
        ...
        equalsNullable(this.description, limitationDto.description) &&
        Objects.equals(this.isAggregatable, limitationDto.isAggregatable) &&
        equalsNullable(this.createdDateUtc, limitationDto.createdDateUtc) &&
        equalsNullable(this.modifiedDateUtc, limitationDto.modifiedDateUtc) &&
        equalsNullable(this.lastModifiedBy, limitationDto.lastModifiedBy);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, productId, name, hashCodeNullable(description), isAggregatable, hashCodeNullable(createdDateUtc), hashCodeNullable(modifiedDateUtc), hashCodeNullable(lastModifiedBy));
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `is_aggregatable` to the URL query string
    if (getIsAggregatable() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sis_aggregatable%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsAggregatable()))));
    }
