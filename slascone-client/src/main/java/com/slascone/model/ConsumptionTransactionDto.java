 ...
 */
@JsonPropertyOrder({
  ConsumptionTransactionDto.JSON_PROPERTY_LIMITATION_ID,
  ConsumptionTransactionDto.JSON_PROPERTY_TRANSACTION_ID
})
...
public class ConsumptionTransactionDto {
  ...
  public ConsumptionTransactionDto limitationId(@jakarta.annotation.Nullable UUID limitationId) {
  ...
  public ConsumptionTransactionDto transactionId(@jakarta.annotation.Nullable UUID transactionId) {
  ...
  /**
   * Return true if this ConsumptionTransactionDto object is equal to o.
   */
  @Override
