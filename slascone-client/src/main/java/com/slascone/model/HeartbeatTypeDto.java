 ...
 */
@JsonPropertyOrder({
  HeartbeatTypeDto.JSON_PROPERTY_ID,
  HeartbeatTypeDto.JSON_PROPERTY_NAME,
  HeartbeatTypeDto.JSON_PROPERTY_CREATED_DATE_UTC,
  HeartbeatTypeDto.JSON_PROPERTY_MODIFIED_DATE_UTC,
  HeartbeatTypeDto.JSON_PROPERTY_LAST_MODIFIED_BY
})
...
public class HeartbeatTypeDto {
  ...
  public HeartbeatTypeDto id(@jakarta.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public HeartbeatTypeDto name(@jakarta.annotation.Nullable String name) {
  ...
  public HeartbeatTypeDto createdDateUtc(@jakarta.annotation.Nullable OffsetDateTime createdDateUtc) {
  ...
  public HeartbeatTypeDto modifiedDateUtc(@jakarta.annotation.Nullable OffsetDateTime modifiedDateUtc) {
  ...
  public HeartbeatTypeDto lastModifiedBy(@jakarta.annotation.Nullable String lastModifiedBy) {
  ...
  /**
   * Return true if this HeartbeatTypeDto object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, heartbeatTypeDto.id) &&
        equalsNullable(this.name, heartbeatTypeDto.name) &&
        equalsNullable(this.createdDateUtc, heartbeatTypeDto.createdDateUtc) &&
        equalsNullable(this.modifiedDateUtc, heartbeatTypeDto.modifiedDateUtc) &&
        equalsNullable(this.lastModifiedBy, heartbeatTypeDto.lastModifiedBy);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, hashCodeNullable(name), hashCodeNullable(createdDateUtc), hashCodeNullable(modifiedDateUtc), hashCodeNullable(lastModifiedBy));
  }
