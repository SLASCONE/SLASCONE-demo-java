 ...
 */
@JsonPropertyOrder({
  UsageModuleDto.JSON_PROPERTY_ID,
  UsageModuleDto.JSON_PROPERTY_PRODUCT_ID,
  UsageModuleDto.JSON_PROPERTY_NAME,
  UsageModuleDto.JSON_PROPERTY_DESCRIPTION,
  UsageModuleDto.JSON_PROPERTY_IS_CHART_RELEVANT,
  UsageModuleDto.JSON_PROPERTY_CREATED_DATE_UTC,
  UsageModuleDto.JSON_PROPERTY_MODIFIED_DATE_UTC,
  UsageModuleDto.JSON_PROPERTY_LAST_MODIFIED_BY
})
...
public class UsageModuleDto {
  ...
  public UsageModuleDto id(@jakarta.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public UsageModuleDto productId(@jakarta.annotation.Nonnull UUID productId) {
  ...
  public UsageModuleDto name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UsageModuleDto description(@jakarta.annotation.Nullable String description) {
  ...
  public UsageModuleDto isChartRelevant(@jakarta.annotation.Nullable Boolean isChartRelevant) {
  ...
  public UsageModuleDto createdDateUtc(@jakarta.annotation.Nullable OffsetDateTime createdDateUtc) {
  ...
  public UsageModuleDto modifiedDateUtc(@jakarta.annotation.Nullable OffsetDateTime modifiedDateUtc) {
  ...
  public UsageModuleDto lastModifiedBy(@jakarta.annotation.Nullable String lastModifiedBy) {
  ...
  /**
   * Return true if this UsageModuleDto object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, usageModuleDto.id) &&
        ...
        equalsNullable(this.description, usageModuleDto.description) &&
        Objects.equals(this.isChartRelevant, usageModuleDto.isChartRelevant) &&
        equalsNullable(this.createdDateUtc, usageModuleDto.createdDateUtc) &&
        equalsNullable(this.modifiedDateUtc, usageModuleDto.modifiedDateUtc) &&
        equalsNullable(this.lastModifiedBy, usageModuleDto.lastModifiedBy);
  }
