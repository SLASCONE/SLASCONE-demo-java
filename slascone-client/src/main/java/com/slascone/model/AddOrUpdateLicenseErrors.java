 ...
 */
@JsonPropertyOrder({
  AddOrUpdateLicenseErrors.JSON_PROPERTY_ID,
  AddOrUpdateLicenseErrors.JSON_PROPERTY_MESSAGE,
  AddOrUpdateLicenseErrors.JSON_PROPERTY_HELP,
  AddOrUpdateLicenseErrors.JSON_PROPERTY_EXPECTED_ERRORS
})
...
public class AddOrUpdateLicenseErrors {
  ...
  public AddOrUpdateLicenseErrors id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public AddOrUpdateLicenseErrors message(@jakarta.annotation.Nullable String message) {
  ...
  public AddOrUpdateLicenseErrors help(@jakarta.annotation.Nullable String help) {
  ...
  public AddOrUpdateLicenseErrors expectedErrors(@jakarta.annotation.Nullable List<ErrorResultObjects> expectedErrors) {
   ...
   */
  @JsonAnySetter
  public AddOrUpdateLicenseErrors putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this AddOrUpdateLicenseErrors object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, addOrUpdateLicenseErrors.id) &&
        equalsNullable(this.message, addOrUpdateLicenseErrors.message) &&
        equalsNullable(this.help, addOrUpdateLicenseErrors.help) &&
        equalsNullable(this.expectedErrors, addOrUpdateLicenseErrors.expectedErrors)&&
        Objects.equals(this.additionalProperties, addOrUpdateLicenseErrors.additionalProperties);
  }
