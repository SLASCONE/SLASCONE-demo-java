 ...
 */
@JsonPropertyOrder({
  LicenseImportByDetailsDto.JSON_PROPERTY_PRODUCT_ID,
  LicenseImportByDetailsDto.JSON_PROPERTY_CUSTOMER_NUMBER,
  LicenseImportByDetailsDto.JSON_PROPERTY_TEMPLATE,
  LicenseImportByDetailsDto.JSON_PROPERTY_LEGACY_LICENSE_KEY,
  LicenseImportByDetailsDto.JSON_PROPERTY_NAME,
  LicenseImportByDetailsDto.JSON_PROPERTY_DESCRIPTION,
  LicenseImportByDetailsDto.JSON_PROPERTY_TOKEN_LIMIT,
  LicenseImportByDetailsDto.JSON_PROPERTY_GOODWILL_TOKEN_LIMIT,
  LicenseImportByDetailsDto.JSON_PROPERTY_FLOATING_TOKEN_LIMIT,
  LicenseImportByDetailsDto.JSON_PROPERTY_USER_LIMIT,
  LicenseImportByDetailsDto.JSON_PROPERTY_START_DATE,
  LicenseImportByDetailsDto.JSON_PROPERTY_EXPIRATION_DATE,
  LicenseImportByDetailsDto.JSON_PROPERTY_LICENSE_TYPE,
  LicenseImportByDetailsDto.JSON_PROPERTY_SOFTWARE_RELEASE_LIMITATION,
  LicenseImportByDetailsDto.JSON_PROPERTY_LICENSE_FEATURES,
  LicenseImportByDetailsDto.JSON_PROPERTY_LICENSE_LIMITATIONS,
  LicenseImportByDetailsDto.JSON_PROPERTY_LICENSE_VARIABLES,
  LicenseImportByDetailsDto.JSON_PROPERTY_LICENSE_CONSTRAINED_VARIABLES,
  LicenseImportByDetailsDto.JSON_PROPERTY_TAGS,
  LicenseImportByDetailsDto.JSON_PROPERTY_IS_ACTIVE,
  LicenseImportByDetailsDto.JSON_PROPERTY_CLIENT_ID,
  LicenseImportByDetailsDto.JSON_PROPERTY_RESUME_ON_ERROR
})
...
public class LicenseImportByDetailsDto {
  ...
  public LicenseImportByDetailsDto productId(@jakarta.annotation.Nonnull UUID productId) {
  ...
  public LicenseImportByDetailsDto customerNumber(@jakarta.annotation.Nonnull String customerNumber) {
  ...
  public LicenseImportByDetailsDto template(@jakarta.annotation.Nonnull String template) {
  ...
  public LicenseImportByDetailsDto legacyLicenseKey(@jakarta.annotation.Nullable String legacyLicenseKey) {
  ...
  public LicenseImportByDetailsDto name(@jakarta.annotation.Nullable String name) {
  ...
  public LicenseImportByDetailsDto description(@jakarta.annotation.Nullable String description) {
  ...
  public LicenseImportByDetailsDto tokenLimit(@jakarta.annotation.Nullable Integer tokenLimit) {
  ...
  public LicenseImportByDetailsDto goodwillTokenLimit(@jakarta.annotation.Nullable Integer goodwillTokenLimit) {
  ...
  public LicenseImportByDetailsDto floatingTokenLimit(@jakarta.annotation.Nullable Integer floatingTokenLimit) {
  ...
  public LicenseImportByDetailsDto userLimit(@jakarta.annotation.Nullable Integer userLimit) {
  ...
  public LicenseImportByDetailsDto startDate(@jakarta.annotation.Nullable String startDate) {
  ...
  public LicenseImportByDetailsDto expirationDate(@jakarta.annotation.Nullable String expirationDate) {
  ...
  public LicenseImportByDetailsDto licenseType(@jakarta.annotation.Nullable String licenseType) {
  ...
  public LicenseImportByDetailsDto softwareReleaseLimitation(@jakarta.annotation.Nullable String softwareReleaseLimitation) {
  ...
  public LicenseImportByDetailsDto licenseFeatures(@jakarta.annotation.Nullable List<String> licenseFeatures) {
  ...
  public LicenseImportByDetailsDto licenseLimitations(@jakarta.annotation.Nullable List<LicenseImportLimitationDto> licenseLimitations) {
  ...
  public LicenseImportByDetailsDto licenseVariables(@jakarta.annotation.Nullable List<LicenseImportVariableDto> licenseVariables) {
  ...
  public LicenseImportByDetailsDto licenseConstrainedVariables(@jakarta.annotation.Nullable List<LicenseImportConstrainedVariableDto> licenseConstrainedVariables) {
  ...
  public LicenseImportByDetailsDto tags(@jakarta.annotation.Nullable List<String> tags) {
  ...
  public LicenseImportByDetailsDto isActive(@jakarta.annotation.Nullable Boolean isActive) {
  ...
  public LicenseImportByDetailsDto clientId(@jakarta.annotation.Nullable String clientId) {
  ...
  public LicenseImportByDetailsDto resumeOnError(@jakarta.annotation.Nullable Boolean resumeOnError) {
  ...
  /**
   * Return true if this LicenseImportByDetailsDto object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.productId, licenseImportByDetailsDto.productId) &&
        ...
        equalsNullable(this.legacyLicenseKey, licenseImportByDetailsDto.legacyLicenseKey) &&
        equalsNullable(this.name, licenseImportByDetailsDto.name) &&
        equalsNullable(this.description, licenseImportByDetailsDto.description) &&
        equalsNullable(this.tokenLimit, licenseImportByDetailsDto.tokenLimit) &&
        equalsNullable(this.goodwillTokenLimit, licenseImportByDetailsDto.goodwillTokenLimit) &&
        equalsNullable(this.floatingTokenLimit, licenseImportByDetailsDto.floatingTokenLimit) &&
        equalsNullable(this.userLimit, licenseImportByDetailsDto.userLimit) &&
        equalsNullable(this.startDate, licenseImportByDetailsDto.startDate) &&
        equalsNullable(this.expirationDate, licenseImportByDetailsDto.expirationDate) &&
        equalsNullable(this.licenseType, licenseImportByDetailsDto.licenseType) &&
        equalsNullable(this.softwareReleaseLimitation, licenseImportByDetailsDto.softwareReleaseLimitation) &&
        equalsNullable(this.licenseFeatures, licenseImportByDetailsDto.licenseFeatures) &&
        equalsNullable(this.licenseLimitations, licenseImportByDetailsDto.licenseLimitations) &&
        equalsNullable(this.licenseVariables, licenseImportByDetailsDto.licenseVariables) &&
        equalsNullable(this.licenseConstrainedVariables, licenseImportByDetailsDto.licenseConstrainedVariables) &&
        equalsNullable(this.tags, licenseImportByDetailsDto.tags) &&
        equalsNullable(this.isActive, licenseImportByDetailsDto.isActive) &&
        equalsNullable(this.clientId, licenseImportByDetailsDto.clientId) &&
