 ...
 */
@JsonPropertyOrder({
  CloseSessionErrors.JSON_PROPERTY_ID,
  CloseSessionErrors.JSON_PROPERTY_MESSAGE,
  CloseSessionErrors.JSON_PROPERTY_HELP,
  CloseSessionErrors.JSON_PROPERTY_EXPECTED_ERRORS
})
...
public class CloseSessionErrors {
  ...
  public CloseSessionErrors id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public CloseSessionErrors message(@jakarta.annotation.Nullable String message) {
  ...
  public CloseSessionErrors help(@jakarta.annotation.Nullable String help) {
  ...
  public CloseSessionErrors expectedErrors(@jakarta.annotation.Nullable List<ErrorResultObjects> expectedErrors) {
   ...
   */
  @JsonAnySetter
  public CloseSessionErrors putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this CloseSessionErrors object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, closeSessionErrors.id) &&
        equalsNullable(this.message, closeSessionErrors.message) &&
        equalsNullable(this.help, closeSessionErrors.help) &&
        equalsNullable(this.expectedErrors, closeSessionErrors.expectedErrors)&&
        Objects.equals(this.additionalProperties, closeSessionErrors.additionalProperties);
  }
