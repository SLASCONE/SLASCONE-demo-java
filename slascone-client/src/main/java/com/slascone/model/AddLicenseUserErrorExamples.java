 ...
 */
@JsonPropertyOrder({
  AddLicenseUserErrorExamples.JSON_PROPERTY_ID,
  AddLicenseUserErrorExamples.JSON_PROPERTY_MESSAGE,
  AddLicenseUserErrorExamples.JSON_PROPERTY_HELP,
  AddLicenseUserErrorExamples.JSON_PROPERTY_EXPECTED_ERRORS
})
...
public class AddLicenseUserErrorExamples {
  ...
  public AddLicenseUserErrorExamples id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public AddLicenseUserErrorExamples message(@jakarta.annotation.Nullable String message) {
  ...
  public AddLicenseUserErrorExamples help(@jakarta.annotation.Nullable String help) {
  ...
  public AddLicenseUserErrorExamples expectedErrors(@jakarta.annotation.Nullable List<ErrorResultObjects> expectedErrors) {
   ...
   */
  @JsonAnySetter
  public AddLicenseUserErrorExamples putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this AddLicenseUserErrorExamples object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, addLicenseUserErrorExamples.id) &&
        equalsNullable(this.message, addLicenseUserErrorExamples.message) &&
        equalsNullable(this.help, addLicenseUserErrorExamples.help) &&
        equalsNullable(this.expectedErrors, addLicenseUserErrorExamples.expectedErrors)&&
        Objects.equals(this.additionalProperties, addLicenseUserErrorExamples.additionalProperties);
  }
