 ...
 */
@JsonPropertyOrder({
  LicensesByCustomerErrors.JSON_PROPERTY_ID,
  LicensesByCustomerErrors.JSON_PROPERTY_MESSAGE,
  LicensesByCustomerErrors.JSON_PROPERTY_HELP,
  LicensesByCustomerErrors.JSON_PROPERTY_EXPECTED_ERRORS
})
...
public class LicensesByCustomerErrors {
  ...
  public LicensesByCustomerErrors id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public LicensesByCustomerErrors message(@jakarta.annotation.Nullable String message) {
  ...
  public LicensesByCustomerErrors help(@jakarta.annotation.Nullable String help) {
  ...
  public LicensesByCustomerErrors expectedErrors(@jakarta.annotation.Nullable List<ErrorResultObjects> expectedErrors) {
   ...
   */
  @JsonAnySetter
  public LicensesByCustomerErrors putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this LicensesByCustomerErrors object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, licensesByCustomerErrors.id) &&
        equalsNullable(this.message, licensesByCustomerErrors.message) &&
        equalsNullable(this.help, licensesByCustomerErrors.help) &&
        equalsNullable(this.expectedErrors, licensesByCustomerErrors.expectedErrors)&&
        Objects.equals(this.additionalProperties, licensesByCustomerErrors.additionalProperties);
  }
