  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerPortalRoleDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException("The required field(s) %s in CustomerPortalRoleDto is not found in the empty JSON string".formatted(CustomerPortalRoleDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerPortalRoleDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException("The field `%s` in the JSON string is not defined in the `CustomerPortalRoleDto` properties. JSON: %s".formatted(entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("customerName") != null && !jsonObj.get("customerName").isJsonNull()) && !jsonObj.get("customerName").isJsonPrimitive()) {
        throw new IllegalArgumentException("Expected the field `customerName` to be a primitive type in the JSON string but got `%s`".formatted(jsonObj.get("customerName").toString()));
      }
      if ((jsonObj.get("customerPortalRoleId") != null && !jsonObj.get("customerPortalRoleId").isJsonNull()) && !jsonObj.get("customerPortalRoleId").isJsonPrimitive()) {
        throw new IllegalArgumentException("Expected the field `customerPortalRoleId` to be a primitive type in the JSON string but got `%s`".formatted(jsonObj.get("customerPortalRoleId").toString()));
      }
  }
