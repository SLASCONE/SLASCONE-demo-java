 ...
 */
@JsonPropertyOrder({
  ResellerTypeDto.JSON_PROPERTY_ID,
  ResellerTypeDto.JSON_PROPERTY_NAME,
  ResellerTypeDto.JSON_PROPERTY_CREATED_DATE_UTC,
  ResellerTypeDto.JSON_PROPERTY_MODIFIED_DATE_UTC,
  ResellerTypeDto.JSON_PROPERTY_LAST_MODIFIED_BY
})
...
public class ResellerTypeDto {
  ...
  public ResellerTypeDto id(@jakarta.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ResellerTypeDto name(@jakarta.annotation.Nullable String name) {
  ...
  public ResellerTypeDto createdDateUtc(@jakarta.annotation.Nullable OffsetDateTime createdDateUtc) {
  ...
  public ResellerTypeDto modifiedDateUtc(@jakarta.annotation.Nullable OffsetDateTime modifiedDateUtc) {
  ...
  public ResellerTypeDto lastModifiedBy(@jakarta.annotation.Nullable String lastModifiedBy) {
  ...
  /**
   * Return true if this ResellerTypeDto object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, resellerTypeDto.id) &&
        equalsNullable(this.name, resellerTypeDto.name) &&
        equalsNullable(this.createdDateUtc, resellerTypeDto.createdDateUtc) &&
        equalsNullable(this.modifiedDateUtc, resellerTypeDto.modifiedDateUtc) &&
        equalsNullable(this.lastModifiedBy, resellerTypeDto.lastModifiedBy);
  }
