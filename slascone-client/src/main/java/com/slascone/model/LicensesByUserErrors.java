 ...
 */
@JsonPropertyOrder({
  LicensesByUserErrors.JSON_PROPERTY_ID,
  LicensesByUserErrors.JSON_PROPERTY_MESSAGE,
  LicensesByUserErrors.JSON_PROPERTY_HELP,
  LicensesByUserErrors.JSON_PROPERTY_EXPECTED_ERRORS
})
...
public class LicensesByUserErrors {
  ...
  public LicensesByUserErrors id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public LicensesByUserErrors message(@jakarta.annotation.Nullable String message) {
  ...
  public LicensesByUserErrors help(@jakarta.annotation.Nullable String help) {
  ...
  public LicensesByUserErrors expectedErrors(@jakarta.annotation.Nullable List<ErrorResultObjects> expectedErrors) {
   ...
   */
  @JsonAnySetter
  public LicensesByUserErrors putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this LicensesByUserErrors object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, licensesByUserErrors.id) &&
        equalsNullable(this.message, licensesByUserErrors.message) &&
        equalsNullable(this.help, licensesByUserErrors.help) &&
        equalsNullable(this.expectedErrors, licensesByUserErrors.expectedErrors)&&
        Objects.equals(this.additionalProperties, licensesByUserErrors.additionalProperties);
  }
